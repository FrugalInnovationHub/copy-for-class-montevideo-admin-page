...
const translations = [
  ...
  ['La foto del material es obligatoria', 'Material photo is required'],
  ['Subir foto', 'Upload photo'],
  ['Sin foto', 'No photo'],
  ['Foto obligatoria', 'Photo required'],
  ['Cambiar foto', 'Change photo'],
  ['Mantener foto actual', 'Keep current photo'],
  ...
  ['Nombre del material en español', 'Material name in Spanish'],
  ['Nombre del material en inglés', 'Material name in English'],
  ['Nombre del submaterial en español', 'Sub-material name in Spanish'],
  ['Nombre del submaterial en inglés', 'Sub-material name in English'],
  ['Los nombres en español e inglés son obligatorios', 'Names in Spanish and English are required'],
  ['Guardando...', 'Saving...'],
  ['Guardar', 'Save'],
  ['Use los mismos identificadores y subcategorías predefinidas que Montevideo App.', 'Use the same preset identifiers and subcategories as Montevideo App.'],
  ['Cargar valores predefinidos de la App', 'Load App presets'],
  ['Sincronizando...', 'Syncing...'],
  ['¿Agregar y sincronizar las categorías predefinidas de Montevideo App?', 'Add and synchronize the preset categories from Montevideo App?'],
  ['Las categorías predefinidas de Montevideo App se sincronizaron correctamente.', 'The Montevideo App preset categories were synchronized successfully.'],
  ['Use esta acción solamente para inicializar o restaurar la estructura predeterminada de materiales.', 'Use this action only to initialize or restore the default material structure.'],
  ['Inicializar / Restaurar materiales predeterminados', 'Initialize / Restore Default Materials'],
  ['Restaurando...', 'Restoring...'],
  ['Esto creará los materiales predeterminados que falten y restaurará sus nombres, colores y estructura. Los estados y el historial se conservarán. ¿Desea continuar?', 'This will create missing default materials and restore their names, colors, and structure. Statuses and history will be preserved. Continue?'],
  ['Los materiales predeterminados se inicializaron o restauraron correctamente.', 'Default materials were initialized or restored successfully.'],
